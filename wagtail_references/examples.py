...
author = {Clark, Thomas and Lueck, Rolf G. and Hay, Alex E. and Davey, Thomas and Stern, Peter and Horwitz, Rachel},
...
title = {{MRCF-TiME-KS9b Turbulence: Best practices for data processing, classification and blah.}},
year = {2015}
}
"""

phdthesis1 = """@phdthesis{robinson1990,
abstract = {The long history of research into the internal structure of turbulent boundary layers has not blah.},
author = {Robinson, S K},
...
abstract = {Further understanding blah blah...

blah TPIV software was developed, with a novel approach permitting a significant reduction in blah and

In support of previous investigations similar topology, strain rate alignment, scale-invariance, and blah.},
